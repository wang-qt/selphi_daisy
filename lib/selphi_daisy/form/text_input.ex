defmodule SelphiDaisy.Form.TextInput do
  @moduledoc """
  文本框，
  ## Properties 继承自 Surface.Components.Form.TextInput
  ...
  • capture_click - Triggered when the component captures clic
  ## 组件自己添加属性
...
#  alias Surface.Components.Form.{Field, FieldContext, TextInput, ErrorTag, Label}
