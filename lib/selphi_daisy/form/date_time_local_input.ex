defmodule SelphiDaisy.Form.DateTimeLocalInput do
  @moduledoc """
  日期时间组件
  """
  use  SelphiDaisy.Form.TextInputBase
  alias Surface.Components.Form.{FieldContext, DateTimeLocalInput}
  ...
  @doc """
  Largest datetime allowed, as enforced by client browser. Not validated by Elixir.
  eg. max="2000-01-03 08:00"
  """
  prop max, :string

  @doc """
  Earliest datetime allowed, as enforced by client browser. Not validated by Elixir.
  eg. min="2000-01-03 08:00"
  """
  prop min, :string
