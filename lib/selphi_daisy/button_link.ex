defmodule SelphiDaisy.ButtonLink do
  @moduledoc """
  A Button element as defined by https://daisyui.com/components/button.

  BtnLink 具有 Button的外观，具有 Link 的所有行为。样式使用 btn btn-primary 等类。
  生成 <a>，且具有 Link、LiveRedirect、LivePatch 的功能。
  主要用在表格的增加、编辑、删除等按钮。因为 liveview 的跳转要比普通的 <a> 复杂的多！
