defmodule SelphiDaisy.CountdownClock.Example03 do
  @moduledoc """
  Countdown.Clock 示例 : 大 clock type = lg-label.
  """
  ...
  def render(assigns) do
    ...
    <div class="flex min-h-[6rem] min-w-[24rem] max-w-4xl items-center justify-center"  >
       <CountdownClock id="clock3" type="lg-label"  />
    </div>
    """
