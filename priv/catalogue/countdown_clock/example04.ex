defmodule SelphiDaisy.CountdownClock.Example04 do
  @moduledoc """
  Countdown.Clock 示例 : 大 clock type = lg-label-down.
  """
  ...
  def render(assigns) do
    ...
    <div class="flex min-h-[6rem] min-w-[24rem] max-w-4xl items-center justify-center" data-theme="dark" >
       <CountdownClock id="clock4" type="lg-label-down"  />
    </div>
    """
