defmodule SelphiDaisy.Form.PasswordInput.Example01 do
  @moduledoc """
  PasswordInput  示例。
  """
  use Surface.Catalogue.Example,
      ...
      height: "500px",
      title: "PasswordInput 组件 color，disabled，readonly，placeholder，maxlength，minlength"
  ...
  def render(assigns) do
    ...
    <Form
      ...
      <PasswordInput  field={:password} placeholder="请输入密码" is_addon />
     ...
     <PasswordInput  field={:password5} placeholder="请输入密码" bordered
