defmodule SelphiDaisy.Form.TextInput.Example03 do
  @moduledoc """
  input-text icon。
  """
  ...
  def render(assigns) do
    ...
    <Form
      ...
      <TextInput  field={:textinput} placeholder="Type here"
              ...
              icon_left="mail" icon_right="check" size="xs"  />

      <TextInput  field={:textinput} placeholder="Type here"
              bordered   color="primary"
             icon_left="mail"  icon_right="check" size="sm"  />

      <TextInput  field={:textinput} placeholder="Type here"
              bordered   color="primary"
             icon_left="mail"  icon_right="check" size="md"  />

      <TextInput  field={:textinput} placeholder="Type here"
              bordered   color="primary"
             icon_left="mail"  icon_right="check" size="lg"  />
