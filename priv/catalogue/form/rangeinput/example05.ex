defmodule SelphiDaisy.Form.RangeInput.Example05 do
  @moduledoc """
  RangeInput  。
  """
  use Surface.Catalogue.Example,
      ...
      height: "400px",
      title: "RangeInput 组件 位于水平组件中 HGroup，忽略label, 优先使用 HGroup 的size   ",
      direction: "vertical"
