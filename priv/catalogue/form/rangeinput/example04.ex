defmodule SelphiDaisy.Form.RangeInput.Example04 do
  @moduledoc """
  RangeInput  。
  """
  use Surface.Catalogue.Example,
      ...
      height: "400px",
      title: "RangeInput 组件 control_class 改变输入框大小 "
  ...
  def render(assigns) do
    ...
    <Form
      ...
      <RangeInput   field={:range} min="0" max="10" value="7" label="Range"
               color="primary"  size="xs" control_class="w-40" />
      <RangeInput   field={:range1} min="0" max="10" value="8" label="Range"
               color="secondary" size="sm" control_class="w-48" />
      <RangeInput   field={:range2} min="0" max="10" value="6" label="Range"
              color="accent" size="md" control_class="w-60" />
