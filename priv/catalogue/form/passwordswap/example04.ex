defmodule SelphiDaisy.Form.PasswordSwap.Example04 do
  @moduledoc """
  PasswordSwap  示例。
  """
  use Surface.Catalogue.Example,
      ...
      height: "500px",
      title: "PasswordSwap 组件 class control_class 改变输入框大小 "
