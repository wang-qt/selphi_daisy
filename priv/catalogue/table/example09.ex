defmodule SelphiDaisy.Table.Example09 do
  @moduledoc """
  Table表格使用示例.
    albums = [
  ...
  def mount(_params,_session,socket) do
    albums = [
      ...
      %{id: 4, name: "Physical Graffiti", job: "Quality Control SpecialistQuality Control SpecialistQuality Control SpecialistQuality Control SpecialistQuality Control Specialist", artist: "Led Zeppelin", released: "February 24, 1975"},
      %{id: 5, name: "Physical Graffiti", job: "Quality Control Specialist", artist: "Led Zeppelin", released: "February 24, 1975"},
      %{id: 6, name: "Physical Graffiti", job: "Quality Control Specialist", artist: "Led Zeppelin", released: "February 24, 1975"},
      %{id: 7, name: "Physical Graffiti", job: "Quality Control Specialist", artist: "Led Zeppelin", released: "February 24, 1975"},
      %{id: 8, name: "Physical Graffiti", job: "Quality Control Specialist", artist: "Led Zeppelin", released: "February 24, 1975"},
  ...
  def render(assigns) do
    ...
    <div class="overflow-x-auto w-full">
      <Table id="live-table" items={album <- @albums} check hover  footer class="table-compact sm:table-normal" >
        ...
        <Column title="job" width="250px"> {album.job} </Column>
        <Column title="Artist">
          <a href="#">{album.artist}</a>
        </Column>
        <Column title="Released" width="100px">
          {album.released}
        </Column>
        <Column title="操作">
