defmodule SelphiDaisy.Table.Example07 do
  @moduledoc """
  Table表格使用示例.
    albums = [
  ...
  def render(assigns) do
    ...
    <div class="overflow-x-auto w-full">
      <Table id="live-table" items={album <- @albums} check hover zebra footer class="table-compact sm:table-normal" >
