defmodule SelphiDaisy.Footer.Example11 do
  @moduledoc """
  Footer 使用示例.
  """
  ...
  def render(assigns) do
    ...
    <Footer color="base-200" class="px-10 py-4 border-t border-base-300">
      <Item class="items-center grid-flow-col">
      ...
      <Item class="class="md:place-self-center md:justify-self-end"">
